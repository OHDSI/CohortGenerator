...
Get the restriction subset definition ids from a cohort definition set
(if any have been added) Useful if keeping track in a script with
complex business logic around what a cohort definition is for
