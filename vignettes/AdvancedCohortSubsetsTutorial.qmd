...
**Currently this code works off of the develop branch of cohort
generator** install with
...
In the last example, we focus on patients exposed to ibuprofen strictly within the year after their celcoxib exposure, but does not overlap with the celcoxib.
```{r}
