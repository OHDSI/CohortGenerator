...
To create a single sample the appraoch below will create cohorts in the same table that
```{r eval=F}
...
cohortDefinitionSet <- generateCohortSet(...)


sampledCohortDefinitionSet <- sampleCohortDefinitionSet(cohortDefinitionSet,
                                                        seed = 64374, # OHDSI
...
* The name now include the postfix `[sample n=1000 seed=64374]`
...
## Using sampling in a design specification
 TODO
