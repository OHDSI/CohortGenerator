...
The following cohorts are produced by a script called SubsetVignetteCohort.R
found in the testdata folder in inst's folder.
The script uses the `Capr` HADES package to define the initial targets.
...
We then add these to a cohort definition set, in which we pull from here.
