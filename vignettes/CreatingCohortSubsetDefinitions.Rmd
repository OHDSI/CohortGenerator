...
subsetOperations <- list(
  ...
  createLimitSubset(id = 1002,
                    ...
                    followUpTime = 0,
                    limitTo = "firstEver",
                    calendarStartDate = lubridate::as_date('2015-01-31'))
)
```
...
connectionDetails <- DatabaseConnector::createConnectionDetails(dbms = "postgresql",
                                                                user = "postgres",
                                                                password = "ohdsi",
                                                                server = "localhost/synthea1k",
                                                                port = 5432)

cohortTableNames <- CohortGenerator::getCohortTableNames(cohortTable = "cohort_subset")
